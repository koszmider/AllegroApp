<%@ Page  Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="lampa_Kronos_Elegance_nocna.aspx.cs" Inherits="LajtIt.AllegroWeb.LampaNocnaKronosElegancePage" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div id="offer">
        <h1 class="item_title color-r">
            Lampa nocna Kronos Elegance</h1>
        <div class="offer_main_photo">
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/kronos/www.lajtit.pl_lampa_nocna_kronos_elegance_biala.jpg"
                    alt="Lampa nocna Kronos Elegance biała" />
                <div class="offer_main_photo_comment">
                    Lampa nocna Kronos Elegance biała</div>
            </div>
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/kronos/www.lajtit.pl_lampa_nocna_kronos_elegance_czarna.jpg"
                    alt="Lampa nocna Kronos Elegance czarna" />
                <div class="offer_main_photo_comment">
                    Lampa nocna Kronos Elegance czarna</div>
            </div>
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/kronos/www.lajtit.pl_lampa_nocna_kronos_elegance_niklowana.jpg"
                    alt="LLampa nocna Kronos Elegance niklowana" />
                <div class="offer_main_photo_comment">
                    Lampa nocna Kronos Elegance niklowana</div>
            </div>
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/kronos/www.lajtit.pl_lampa_nocna_kronos_elegance_niklowana2.jpg"
                    alt="LLampa nocna Kronos Elegance niklowana" />
                <div class="offer_main_photo_comment">
                    Włącznik znajduje się na podstawce</div>
            </div> 
        </div>
        <div class="offer_spec">
            <table> 
                ...
                <tr>
                    ...
                    <td>
                       Materiał stal. Kolory:  biała, czarna lub niklowana. Długość kabla 2,1m. Średnica podstawki 14cm. Włącznik na podstawce.
                    </td>
                </tr>
                <tr>
                    <td>
