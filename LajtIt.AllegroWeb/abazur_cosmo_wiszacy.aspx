<%@ Page  Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="abazur_cosmo_wiszacy.aspx.cs" Inherits="LajtIt.AllegroWeb.AbazurWiszacyCosmoPage " %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
  <div class="price">
    ...
    <div class="regular_text">W tej aukcji oferujemy sam abażur, jeśli chcą Państwo nabyć komplet: abażur z kablem zasilającym (zawieszką) <a href="http://allegro.pl/listing.php/search?category=5318&us_id=678165&string=Cosmo" target="_blank" style="text-decoration: underline;">zapraszamy na pozostałe nasze aukcje</a>.
    </div>
    <div class="regular_text">
        Abażur Cosmo dostępny jest w wielu kolorach i w wielu układach kolorystycznych. Poniżej
