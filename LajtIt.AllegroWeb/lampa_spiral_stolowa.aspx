<%@ Page  Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="lampa_spiral_stolowa.aspx.cs" Inherits="LajtIt.AllegroWeb.LampaStolowaSpiralPage" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div id="offer">
        <h1 class="item_title color-r">
            Lampa stołowa Spiral</h1>
        <div class="offer_main_photo">
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/allegro/www.magic-lamps.pl_Spiral_stolowy_bialy.jpg"
                    alt="Lampa stołowa Spiral" />
            </div>
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/allegro/www.lajtit.pl_lama_stolowa_spiral.jpg"
                    alt="Lampa stołowa Spiral" />
    ...
    <div class="offer_spec_comments">
        * Kolory abażurów: biały, czarny, żółty, czerwony 
    </div>
    <div class="regular_text">
        ...
        <div style="text-align: center;">
            <img src="http://www.lajtit.pl/public/assets/allegro/www.magic-lamps.pl_Spiral_wszystkie.jpg"
                ...
                <tr style="text-align:center;"><td><img src="http://www.lajtit.pl/userdata/gfx/6bd7e25e89ac8168b6e93338a8de3891.jpg"  width="200px" alt="Lampa stołowa spiral" /></td>
                <td><img src="http://www.lajtit.pl/userdata/gfx/84a05b657cfbe21f31b9a42cde42aa03.jpg" alt="Lampa stołowa spiral" width="200px" /></td>
                </tr>
                </table>
        </div>
    </div>
