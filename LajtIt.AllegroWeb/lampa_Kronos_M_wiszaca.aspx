<%@ Page  Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="lampa_Kronos_M_wiszaca.aspx.cs" Inherits="LajtIt.AllegroWeb.LampaWiszacaKronosMPage" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="offer">
        ...
        <div class="offer_main_photo">
            ...
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/kronos_trio/www.lajtit.pl_lampa_wiszaca_kronos_trio.jpg"
                    alt="Lampa wisząca Kronos" />
                    <div class="offer_main_photo_comment">Lampy Kronos na potrójnym zwisie, czyli lampa <a href="http://allegro.pl/listing/user.php?string=kronos+trio&us_id=678165" target="_blank">Kronos Trio</a> (kliknij i dowiedz się więcej)</div>
            </div>
        </div>
