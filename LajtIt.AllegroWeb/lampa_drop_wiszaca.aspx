<%@ Page  Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="lampa_drop_wiszaca.aspx.cs" Inherits="LajtIt.AllegroWeb.LampaWiszacaDropPage" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div id="offer">
        <h1 class="item_title color-r">
            Lampa wisząca Drop</h1>
        <div class="offer_main_photo">
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/userdata/gfx/e45ecee8b48b9d324ed52f5f19d44337.jpg"
                    alt="Lampa wisząca Drop" />
            </div>
        </div>
    ...
    <div class="offer_spec_comments">
        * Kolory abażurów: biały, czerwony, zielony<br />
