<%@ Page  Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="lampa_szklana2_wiszaca.aspx.cs" Inherits="LajtIt.AllegroWeb.LampaWiszacaSzklana2Page" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div id="offer">
        ...
        <div class="offer_main_photo">
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/allegro/lampa_szklana_mala_1.jpg" alt="Lampa wisząca" />
            </div>
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/allegro/lampa_szklana_mala_2.jpg" alt="Lampa wisząca " />
            </div> 
        </div>
        <div class="offer_spec">
            <table>
                <tr>
                    ...
                    <td>
                        23cm  (<a href="http://allegro.pl/Shop.php/Show?category=&country=1&buy=0&shop=0&order=&price_from=&price_to=&listing=0&listing_sel=&listing_interval=&pay=0&redir_to_search=1&string=mro%C5%BCone&id=678165" target="_blank">dostępne są też lampy o większej średnicy 30cm, sprawdź tutaj</a>)
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <div id="suggestions">
        <img src="http://www.lajtit.pl/public/assets/allegro/lajtit_produkty_uzupelniajace.png"
            alt="Produkty uzupełniające" />   <div class="regular_text">Polecamy również:<br /><br />
                <table style="border: solid 1px black;">
                    <tr>
                        ...
                        <td>
                            <a href="http://allegro.pl/listing/user/listing.php?us_id=678165&string=szklana&search_scope=userItems-678165&price_from=19&price_to=20&price_enabled=1"
                                target="_blank">
                                <img src="http://www.lajtit.pl/public/assets/allegro/lampa_szklana_1.jpg" style="border: 0px;
                                    width: 150px" /></a>
                        </td>
                        <td>Szklana<br />Średnica 30cm<br />
                            Cena: 19,99 zł
                        </td>
