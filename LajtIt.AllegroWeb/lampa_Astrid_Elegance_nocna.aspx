<%@ Page  Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="lampa_Astrid_Elegance_nocna.aspx.cs" Inherits="LajtIt.AllegroWeb.LampaNocnaAstridElegancePage" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="offer">
        <h1 class="item_title color-r">
            Lampa nocna Astrid Elegance</h1>
        <div class="offer_main_photo">
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/allegro/www.lajtit.pl_modne_lampy_nocne_astrid_elegance.jpg"
                    alt="Lampa nocna Astrid" />
                    <div class="offer_main_photo_comment">Lampka nocna Astrid Elegance (abażur biały)</div>
            </div>
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/allegro/www.lajtit.pl_modne_lampy_nocne_astrid_elegance_detal.jpg"
                    alt="Lampa nocna Astrid" />
                    <div class="offer_main_photo_comment">Podstawa lampki</div>
            </div>
        </div>
        <div class="offer_spec">
            <table> 
                ...
                <tr>
                    ...
                    <td>
                        Kabel: 145cm, włącznik na kablu;  Talerz bazowy: lakier bezbarwny, formowana sklejka brzozowa
płyta; rurka: stal, powłoka niklowa
                    </td>
                </tr>  
                <tr>
                    <td>
