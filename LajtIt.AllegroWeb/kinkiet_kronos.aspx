<%@ Page  Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="kinkiet_kronos.aspx.cs" Inherits="LajtIt.AllegroWeb.KinkietKronosPage " %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="offer">
        ...
        <div class="offer_main_photo">
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/userdata/gfx/d68c83a4151e54c3ebb338ccef8e8893.jpg"
                    alt="Kinkiet Kronos" />
            <div class="offer_main_photo_comment">Wersja bez kabla zasilającego</div>
            </div><br />
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/userdata/gfx/438455cc8e64bf4b5e1dcc3e38030d32.jpg"
                    alt="Kinkiet Kronos" />
            <div class="offer_main_photo_comment">Wersja z kablem zasilającym</div>
            </div>
        </div>
    ...
    ** Kabel zasilający można usunąć i przystosować kinkiet do zasilania bezpośrednio ze ściany
