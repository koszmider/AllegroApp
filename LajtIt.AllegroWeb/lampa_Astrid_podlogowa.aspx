<%@ Page  Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="lampa_Astrid_podlogowa.aspx.cs" Inherits="LajtIt.AllegroWeb.LampaPodlogowaAstridPage" %>
...
<%--    <div class="price">
    ...
    <div id="offer">
        <h1 class="item_title color-r">
            Lampa podłogowa Astrid</h1>
        <div class="offer_main_photo">
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/userdata/gfx/ebfcd61660ef088f788a23dbc3d76214.jpg"
                    alt="Lampa podłogowa Astrid" />
            </div> 
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/allegro/astrid_elegance/www.lajtit.pl_modna_lampa_podlogowa_astrid_elegance.jpg"
    ...
    <div class="regular_text">
        <div class="special_box" style="height:250px;">
           <img src="http://www.lajtit.pl/public/assets/allegro/astrid_kronos_glowna.jpg" style="width:300px; float:left; vertical-align:top; padding:5px;" alt=""/> Do zakupionej w tej aukcji lampy podłogowej Astrid  oferujemy  gratisowo lampę wiszącą Kronos 35cm (taką jak w <a href="http://allegro.pl/hit-kronos-piekne-lampy-rozm-l-35cm-i3045956788.html" target="_blank">tej aukcji</a>) o wartości 49,90zł!</br></br>
