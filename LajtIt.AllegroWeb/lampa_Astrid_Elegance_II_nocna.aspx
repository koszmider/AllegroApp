<%@ Page  Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="lampa_Astrid_Elegance_II_nocna.aspx.cs" Inherits="LajtIt.AllegroWeb.LampaNocnaAstridEleganceIIPage" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="offer">
        <h1 class="item_title color-r">
            Lampa nocna Astrid Elegance II</h1>
        <div class="offer_main_photo">
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/kronos/astrid_elegance_II.jpg"
                    alt="Lampa nocna Astrid" />
                    <div class="offer_main_photo_comment">Lampka nocna Astrid Elegance (abażur biały)</div>
            </div>
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/kronos/astrid_elegance_II_podstawka.jpg"
                    alt="Lampa nocna Astrid" />
        ...
        <div class="offer_spec">
            <table> 
                ...
                <tr>
                    ...
                    <td>
                        Kabel: 2m, włącznik na kablu;  stal, powłoka niklowa, wymiary 12x18cm
                    </td>
                </tr>  
