<%@ Page  Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="lampa_Tromle_XL_podlogowa.aspx.cs" Inherits="LajtIt.AllegroWeb.LampaPodlogowaTromleXLPage" %>
    ...
    <div id="offer">
        ...
        <div class="offer_main_photo">
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/allegro/tromle/www.lajtit.pl_modne_lampa_podlogowa_tromle_xl_biala_1.jpg"
                    alt="Lampa wisząca Tromle" />
                    <div class="offer_main_photo_comment">Biała lampa podłogowa Tromle XL</div>
            </div>
           <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/tromle/www.lajtit.pl_modne_lampa_podlogowa_tromle_xl_biala.jpg"
                 style="width:200px"   alt="Lampa podłogowa Tromle" />
                    <div class="offer_main_photo_comment">Biała lampa podgłogowa Tromle XL</div>
            </div>
           <%--  <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/tromle/www.lajtit.pl_modne_lampa_podlogowa_tromle_xl_biala2.jpg"
                style="width:200px"    alt="Lampa podłogowa Tromle" />
