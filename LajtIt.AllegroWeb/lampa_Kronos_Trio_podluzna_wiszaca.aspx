<%@ Page  Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="lampa_Kronos_Trio_podluzna_wiszaca.aspx.cs" Inherits="LajtIt.AllegroWeb.LampaWiszacaKronosTrio2Page" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="offer">
        ...
        <div class="offer_main_photo">
            ...
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/kronos_trio/www.lajtit.pl_lampa_wiszaca_kronos_trio2_aranzacja.jpg"
                    alt="Lampa wisząca Kronos Trio" />
            ...
            <div class="offer_main_photo_frame">
                <img src="http://www.lajtit.pl/public/assets/kronos_trio/www.lajtit.pl_lampa_wiszaca_kronos_trio_od_dolu_z_boku.jpg"
                    ...
                    <div class="offer_main_photo_comment">Polecamy również: <a href="http://allegro.pl/listing/user.php?string=kronos+trio&us_id=678165" target="_blank">Kronos Trio w wersji z okrągłym plafonem. Kliknij tutaj i dowiedz się więcej</a>.<br />Ta lampa oferowana jest na innych naszych aukcjach.</div>
            </div>
        </div>
        <div class="offer_spec">
            <table> 
                ...
                <tr>
                    ...
                    <td>
                        metalowy, <a href="#plafon_kolor">kolor srebrny</a> **, długość 60cm
                    </td>
                </tr>
                <tr>
                    <td>
