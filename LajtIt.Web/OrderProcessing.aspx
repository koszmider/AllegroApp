                ...
                <div>
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="text-align:right;">
                                <asp:Button Text="Zmień InPost paczkomat na InPost kurier" Visible="true"  ID="lbtnShippingModeChange1" runat="server" CausesValidation="false"
                                    OnClientClick="return confirm('Czy napewno chcesz zmienić przesyłkę paczkomatową InPost na wysyłkę kurierską InPost?');"
                                    OnClick="lbtnShippingModeChange1_Click"></asp:Button>
                                <asp:Button Text="Zmień InPost paczkomat na DPD kurier" Visible="true"  ID="lbtnShippingModeChange" runat="server" CausesValidation="false"
                                    OnClientClick="return confirm('Czy napewno chcesz zmienić przesyłkę paczkomatową InPost na wysyłkę kurierską DPD?');"
                                    OnClick="lbtnShippingModeChange_Click"></asp:Button>
